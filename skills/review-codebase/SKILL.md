...
Convert the final report to a professionally styled PDF using the `/mp-pdf` skill.

Invoke the skill with:
- Input: `tech-dd-report.md`
- Title: "Tech Due Diligence Report: [Project Name]"

This produces `tech-dd-report.html` and `tech-dd-report.pdf` with m+p corporate branding and rendered Mermaid diagrams.
...
2. `tech-dd-report.html` and `tech-dd-report.pdf` (generated by `/mp-pdf`)
